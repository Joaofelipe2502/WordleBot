...
def find_best_guess(valid_words, dictionary):
    ...
    for guess in dictionary:
        ...
        # For guess in dictionary, append it to the guess list with the average number of remaining words
        i += 1
        print(f"{i} - {round((i/14855)*100, 3)}%")
        # Progress report, del this out later
    guess_list.sort(key=lambda x: x.avg_remaining_words)
    # Sorts the guess list by average remaining words
    return guess_list
